...
#		  n = 5		 n = 10		 n = 30
Px_1 = [Pxs[0:20], Pxs[20:40], Pxs[40:60]]			#	sen(x)
Py_1 = [Pys[0:20], Pys[20:40], Pys[40:60]]			#	sen(x)

Px_2 = [Pxs[60:80], Pxs[80:100], Pxs[100:120]]		#	cos(x)
Py_2 = [Pys[60:80], Pys[80:100], Pys[100:120]]		#	cos(x)

Px_3 = [Pxs[120:140], Pxs[140:160], Pxs[160:180]]	#	x . e ** -2x
Py_3 = [Pys[120:140], Pys[140:160], Pys[160:180]]	#	x . e ** -2x
